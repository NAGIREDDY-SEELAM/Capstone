     ...
     <View style={styles.insidecontainer}>
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput
          ...
          placeholder="Enter your complaint/message"
          multiline
        />
      </View>
   
      <TouchableOpacity onPress={saveComplaint}>
      <Text style={{backgroundColor: '#086487',
    padding: 10,
  color:'white',
    alignItems: 'center',
    alignSelf:'center',
    borderRadius: 25,
    fontWeight:'bold',
    fontSize: 16,}}>Submit Complaint</Text>
    </TouchableOpacity>
      </View> 
      <View style={styles.complaintHistoryContainer}>
        ...
        {complaintHistory.map((item, index) => (
          <View key={index} style={styles.complaintItem}>
            <Text style={{fontWeight:'500',fontSize:18}}>Name: <Text style={{fontWeight:'normal',fontSize:16}}>{item.name}</Text></Text>
            <Text style={{fontWeight:'500',fontSize:18}}>Phone Number:<Text style={{fontWeight:'normal', fontSize:16}}> {item.phoneNumber}</Text></Text>
            <Text style={{fontWeight:'500',fontSize:18}}>Complaint/Message: <Text style={{fontWeight:'normal', fontSize:16}}>{item.complaint}</Text></Text>
